...
| 2026-09-12 | Pedido `enviado` com pacote sem EE: conta junta os itens no rastreio que existe (não mostra “aguardando”). Split 1/2 só em pedido ainda aberto | #853 original deixa de misturar reenvio/estoque; #1091 igual | Webhook/create/admin iguais |
