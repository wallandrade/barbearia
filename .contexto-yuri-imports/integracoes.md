...
| 2026-09-10 | Baixa do espelho com senha + janela 10 min (`unlock` / `password` no exit). Snapshot sem senha | Outro sistema pede senha de novo depois de 10 min | Token do snapshot e webhook iguais |
