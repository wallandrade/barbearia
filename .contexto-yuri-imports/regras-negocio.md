...
|------|--------|---------|-----------------|
| 2026-09-02 | Admin Seguro: título e texto de cada opção do checkout são editáveis (`checkout_insurance_full_label` / `_full_description` / `_reduced_label` / `_reduced_description`) | Cliente vê o que está salvo; vazio = default | %, cobertura e preço iguais |
