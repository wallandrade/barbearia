...
|------|--------|---------|-----------------|
| 2026-09-06 | Admin Seguro: interruptor **Devolver saldo se chegar certo** (`checkout_insurance_cashback_enabled`, default ligado). Desligado: snapshot `cashback=0`, checkout explica que não vira saldo | Completo deixa de creditar carteira nas compras novas | Plano, %, 1 reenvio e reduzido iguais; pedido antigo com saldo gravado ainda recebe |
