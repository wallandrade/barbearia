...
|------|--------|---------|-----------------|
| 2026-09-03 | Saída manual de estoque: usa o saldo da linha (id órfão / nome recadastrado com sufixo). Clique na lista preenche o formulário | Dá para zerar Foz/Motoboy/Minas depois de recadastrar produto | Entrada, compra fornecedor e baixa de pedido iguais |
