            ...
            <picture>
              ...
              {banners["banner_desktop"] ? (
                <img
                  ...
                  fetchPriority="high"
                  className="block w-full h-auto sm:h-[260px] md:h-[380px] object-cover object-center"
                />
              ) : banners["banner_mobile"] ? (
                <img
            ...
            <picture>
              ...
              {banners["catalog_banner_desktop"] ? (
                <img
                  ...
                  fetchPriority="high"
                  className="block w-full h-auto sm:h-[220px] md:h-[300px] rounded-3xl object-cover object-center shadow-sm border border-border/40"
                />
              ) : banners["catalog_banner_mobile"] ? (
                <img
