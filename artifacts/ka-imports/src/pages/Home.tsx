            ...
            <picture>
              ...
              {banners["banner_desktop"] ? (
                <img
                  ...
                  fetchPriority="high"
                  className="block w-full h-auto sm:h-[260px] md:h-[380px] object-contain object-center bg-muted/20"
                />
              ) : banners["banner_mobile"] ? (
                <img
            ...
            <picture>
              ...
              {banners["catalog_banner_desktop"] ? (
                <img
                  ...
                  fetchPriority="high"
                  className="block w-full h-auto sm:h-[220px] md:h-[300px] rounded-3xl object-contain object-center bg-muted/20 shadow-sm border border-border/40"
                />
              ) : banners["catalog_banner_mobile"] ? (
                <img
